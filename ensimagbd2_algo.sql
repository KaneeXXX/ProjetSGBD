...
CREATE TABLE ADHERENT (
   ...
   MDP VARCHAR(20),
   PRIMARY KEY (EMAIlMEMBRE, MDP),
   NOM VARCHAR(20),
   PRENOM VARCHAR(20),
   ADrPOST VARCHAR(30),
   IdAdherent INT -- à changer sur le schéma de conception
);
...
CREATE TABLE EST_PARENT_DE (
   CATEGORIePARENT REFERENCES ARBRE(CATEGORIE) PRIMARY KEY
   CATEGORIeENFANT REFERENCES ARBRE(CATEGORIE)
);
