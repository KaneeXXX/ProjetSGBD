...
\att{LOT}(\att{\underline{marque}}, \att{\underline{modele}}, \att{\underline{anneeAchat}}, \att{nbPiecesLot}, \att{prixPerteDegr}, \att{textInfo}, \att{anneePerem}, \att{categorie})
\begin{itemize}
